...
function RouteComponent() {
  return (
    <main className="flex-1 bg-[#242424] text-white p-3 pt-[100px]">
      <div className="p-10">
        <div className="nunitofont tracking-widest text-center text-xl pb-20">
          HOW IT WORKS
        </div>
        <img src={step1} alt="" />
      </div>
      <img src={step2} alt="" className="mx-auto mt-10 mb-20" />
      <img src={step3} alt="" className="mx-auto" />
      <div className="text-center py-32">
        <div className="text-2xl md:text-6xl font-bold pb-10">
