  ...
  return (
    <main className="flex-1 bg-[#242424] p-3 pt-[100px] text-[#D9D9D9] md:text-xl">
      ...
      <div className="text-center">
        <div
          className="workfont text-2xl md:text-6xl font-bold"
          id="getting-started"
        >
          Common questions
        </div>
      ...
      <div className="flex flex-col mx-auto">
        <div className="hidden md:block fixed top-72 left-20 mr-10 pt-5">
          ...
          >
            Integrating Arkhet into workflows
          </div>
          <div className="h-[2px] bg-white opacity-10"></div>
          <div
            className="py-5 hover:bg-white hover:text-black ease-in-out duration-500 cursor-pointer"
        ...
        <div className="pb-60 mx-auto md:pl-96">
          <div className="pb-3">
          ...
          <div className="py-3" id="prototype-section">
            <div className="text-white text-2xl pb-3 font-semibold">
          ...
          <div className="py-3">
            ...
            <div>
              You have an idea for a software experience? Build the a wireframe
              and Arkhet will <br />
              generate the interactive prototype to your specification in
              moments. <br />
              <br />
              Assemble a wireframe from the component library with the intuitive
              drag-and-
              <br />
              drop interface. Once your idea is on the board, Arkhet produces an
              interactive <br />
              software to your specification in the form of a prototype web app.
            </div>
          </div>
          <div className="py-3">
            <div className="text-white text-2xl pb-3 font-semibold">
          ...
          <div className="py-3">
            ...
            <div>
              ...
              Arkhet generates interactive prototypes that make it possible for
              teams to test <br />
              ideas at higher fidelity and lower cost than ever before, and more
              often.
            </div>
          </div>
          <div className="py-3">
            ...
            <div>
              The interactive prototype is generated directly (and solely) from
              your wireframe. <br />
          ...
          <div className="py-3">
            <div className="text-white text-2xl pb-3 font-semibold">
              Wait… Arkhet can build interactive prototypes with AI Components?
            </div>
            <div id="integrating">
              ...
              <br />
              Teams implementing AI solutions directly or in collaboration with
              others can <br /> quickly test emerging technologies during
              development.
            </div>
          </div>
          <div className="py-3" id="security">
            <div
              className="text-white text-2xl pb-3 font-semibold"
              id="involved"
            >
            ...
            <div>
              ...
              prototype so you don't have to write (or rewrite) a single prompt.
            </div>
          </div>
          <div className="py-3">
            <div className="text-white text-2xl pb-3 font-semibold">
          ...
          <div className="py-3">
            ...
            <div>
              ...
              enforced by AWS <br /> Bedrock, ensuring that none of your data is
              available beyond your use. <br />
